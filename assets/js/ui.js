...
" in the document "ui.js aggiornato" above and my user query is "riscrivi il file in canvasa _core/google_client.php attuale:
...
Carica l’autoload prima di usare Google_Client
Apri _core/google_client.php e alla primissima riga utile metti:

<?php
// carica l'autoload di Composer (partendo da _core/ si risale di una cartella)
require_once dirname(__DIR__) . '/vendor/autoload.php';

// ...poi il tuo codice che crea il client
$client = new Google_Client();  // <-- qui ora la classe esiste
Se già avevi un require 'vendor/autoload.php'; ma era con un percorso relativo sbagliato, non funzionava. Da _core/ devi usare dirname(__DIR__) . '/vendor/autoload.php'.

scrivimi il file completo e finito grazie".
